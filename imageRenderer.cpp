...
void renderImage(cv::String &filepath) {
    ...
    if(!image.data) {
        std::cout << "No image data found at specified path." << "\n";
        return;
    }

    Terminal t = Terminal(image);
